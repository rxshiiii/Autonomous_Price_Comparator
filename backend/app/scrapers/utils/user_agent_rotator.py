"""
User Agent Rotator for anti-bot measures.
Provides a pool of realistic user agents to rotate through.
"""
import random
...
class UserAgentRotator:
    ...
    def __init__(self):
        """Initialize with a pool of user agents."""
    ...
    def get_mobile_user_agent(self) -> str:
        ...
        """
        mobile_agents = [ua for ua in self.user_agents if "Mobile" in ua or "iPhone" in ua or "Android" in ua]
    ...
    def get_desktop_user_agent(self) -> str:
        ...
        """
        desktop_agents = [ua for ua in self.user_agents if "Mobile" not in ua and "iPhone" not in ua and "Android" not in ua and "iPad" not in ua]
